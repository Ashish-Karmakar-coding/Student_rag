...
import { tagChunks, inferSubject, collectUniqueConcepts } from "./conceptTagger";
import { embedAndUpsert } from "./embedder";
import { IngestJob, calcJobProgress, deriveJobStatus } from "../models/IngestJob";
...
async function processFile(
  ...
  const taggedChunks = await tagChunks(chunks, llm);
